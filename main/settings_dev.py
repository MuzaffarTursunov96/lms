...
#python manage.py runserver 127.0.0.1:8001 --settings=main.settings_dev
...
DATABASES = {
    ...
    #     "NAME": os.getenv("POSTGRES_DB", "my_lms_db"),
...
STATIC_URL = '/static/'
# STATIC_ROOT = [os.path.join(BASE_DIR, 'static')]  # for your local static files
...
# File upload access
CKEDITOR_5_FILE_UPLOAD_PERMISSION = "authenticated"   # "staff", "authenticated", or "any"

# Limit upload size (MB)
CKEDITOR_5_MAX_FILE_SIZE = 5000

# Auto-adjust language with Django’s current language
